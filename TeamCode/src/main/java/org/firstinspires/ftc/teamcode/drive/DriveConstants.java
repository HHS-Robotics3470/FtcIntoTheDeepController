...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 20.0/22.0; // output (wheel) speed / input (motor) speed
    ...
    public static double MAX_ANG_VEL = 4.7;
    public static double MAX_ANG_ACCEL = 4.7;
